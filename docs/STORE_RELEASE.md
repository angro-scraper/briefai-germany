...
6. Ručno pokrenuti GitHub workflow sa sledećim većim `build_number`. Preuzeti AAB artefakt, poslati ga u Play Console internal testing i proveriti App Check, prijavu, OCR, AI analizu, odgovor, podsetnik i restore na stvarnom uređaju.
...
4. Napraviti archive preko Xcode-a, poslati TestFlight build i na fizičkom iPhone-u proveriti Apple login, push dozvolu, OCR, kupovinu, restore i brisanje naloga.
